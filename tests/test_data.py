...
class TestRegistry(unittest.TestCase):
    ...
    def test_reset_index(self):
        ...
        pd.testing.assert_frame_equal(actual, expected)
        actual = registry.reset_index(comp_a.set_index(["entity", "comp_ind"]))
        pd.testing.assert_frame_equal(actual, expected)
    ...
    def test_multi_join_vars(self):
        components = {
            ...
            "comp2": pd.DataFrame({
                ...
                "comp_ind": [1, 3],
                "field2": ["a", "b"],
                "entity_field2": ["entity2", "entity2"]
            }),
            "comp3": pd.DataFrame({
                "entity": ["entity1", "entity2",],
                "comp_ind": [4, 1],
                "field3": [-1, -2],
                "entity_field3": ["entity2", "entity1",],
            }),
        }
        registry = data.Registry(components)
        ...
        view = data.View(
            ["comp1", "comp2", "comp3"],
            ["entity", "entity_field2", "entity_field3"],
        )
